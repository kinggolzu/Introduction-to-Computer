...
<div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
    <div class="mdl-tabs__tab-bar">
        <a href="#group1" class="mdl-tabs__tab is-active">一组</a>
        <a href="#group2" class="mdl-tabs__tab">二组</a>
        <a href="#group3" class="mdl-tabs__tab">三组</a>
        <a href="#group4" class="mdl-tabs__tab">四组</a>
        <a href="#group5" class="mdl-tabs__tab">五组</a>
        <a href="#group6" class="mdl-tabs__tab">六组</a>
        <a href="#group7" class="mdl-tabs__tab">七组</a>
        <a href="#group8" class="mdl-tabs__tab">八组</a>
        <a href="#group9" class="mdl-tabs__tab">九组</a>
        <a href="#group10" class="mdl-tabs__tab">十组</a>
    </div>
    ...
    <div class="mdl-tabs__panel is-active" id="group7">
      <ol style="margin-top: 20px;">
        ...
        <li style="margin-top: 10px"><p>成果展示视频</p>
          ...
          <p style="font-style: italic; font-size: 12px;line-height: 14px">第二次尝试</p>
